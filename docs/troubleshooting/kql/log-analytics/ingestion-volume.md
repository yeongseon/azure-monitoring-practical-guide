...
## Sources
*   [MS Learn: Usage table reference](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/usage)
*   [MS Learn: Cost and usage in Azure Monitor](https://learn.microsoft.com/en-us/azure/azure-monitor/logs/log-analytics-overviewmanage-cost-storage)
