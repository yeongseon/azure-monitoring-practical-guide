...
- [Log Analytics workspace limits](https://learn.microsoft.com/en-us/azure/azure-monitor/logs/log-analytics-overviewlog-analytics-workspace-overview#workspace-limits)
